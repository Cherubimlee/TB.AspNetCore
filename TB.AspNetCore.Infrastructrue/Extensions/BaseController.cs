    ...
    public class BaseController:Controller
    {
        ...
        public override void OnActionExecuted(ActionExecutedContext context)
        {
            if (context.Exception != null)
            {
                ...
                {
#if DEBUG
                    context.Result = Json(new Result(context.Exception, true));
#else
                     context.Result = Json(new Result(context.Exception));
#endif
                ...
                {
#if DEBUG
                    context.Result = View("Error", new Result(context.Exception, true));
#else
                    context.Result = View("Error", new Result(context.Exception));
#endif
                }
                return;
            }
