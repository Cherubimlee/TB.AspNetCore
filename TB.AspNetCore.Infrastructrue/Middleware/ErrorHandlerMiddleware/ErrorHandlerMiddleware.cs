    ...
    public class ErrorHandlerMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            try
            {
                ...
                if (!SuccessCode.Contains(context.Response.StatusCode))
                {
                    ...
                    if (context.IsAjaxRequest())
                    {
                        ...
                        Result response2 = new Result(statusCode2, msg, (Exception)null);
                        await context.Response.WriteJsonAsync((object)response2.GetJson());
                    }
                }
            }
            catch (Exception exception)
            {
                ...
                {
                    context.Response.ContentType = "application/json;charset=utf-8";
                    Result response = new Result(statusCode, message.ToString(), (Exception)null);
                    await context.Response.WriteJsonAsync((object)response.GetJson());
                }
            }
        }
    }
