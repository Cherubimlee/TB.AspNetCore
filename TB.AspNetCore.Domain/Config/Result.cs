...
namespace TB.AspNetCore.Domain.Config
{
    public class Result
    {
        ...
        public Result(Enum status, string message = "")
        {
            SetStatus(status, message);
        }

        public Result(Exception exception, bool showStackTrace = false)
        {
            SetStatus(exception, showStackTrace);
        }

        public virtual Result SetError(string errorMessage)
        {
            Status = 501;
        ...
        public Result(int status, string message, Exception ex = null)
        {
            Status = status;
            if (ex != null)
            {
        ...
        public Result Error(Exception exception, bool showStackTrace = false)
        {
            if (exception == null)
            {
        ...
        public virtual Result SetStatus(Exception exception, bool showStackTrace = false)
        {
            Status = 500;
        ...
        public virtual Result SetStatus(Enum status, string message = "")
        {
        ...
        public virtual Result SetStatus(int status, string message)
        {
            Data = defaultData;
            Status = status;
            _message = message;
