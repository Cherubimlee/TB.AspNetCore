...
namespace TB.AspNetCore.Application.Services
{
    public class AccountService:BaseService, IAccountService
    {
        ...
        /// <returns></returns>
        public Result Login(BackstageUserAdd model)
        {
        ...
        /// <returns></returns>
        public Result AddAccount(BackstageUserAdd model)
        {
            Result result = new Result();
            BackstageUser account = this.First<BackstageUser>(t => t.LoginName == model.LoginName);
            if (account != null)
        ...
        /// <returns></returns>
        public Result UpdatePwd(BackstageUserAdd model)
        {
            Result result = new Result();
        ...
        /// <returns></returns>
        public Result UpdateAccount(BackstageUserAdd model)
        {
            Result result = new Result();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public Result GetBackstageUserList(AccountSearchModel model)
        {
            Result result = new Result();
